...
rospy.init_node('pq5_codigo5_twist_sub_pub', anonymous=True)	
...
def callback(data):
	...
	# rospy.loginfo("w: %d", joint4_value)

sub = rospy.Subscriber("pq5_codigo4_quaternion_sub_pub", Quaternion, callback)   
pub = rospy.Publisher('pq5_codigo5_twist_sub_pub', Twist, queue_size=10)
