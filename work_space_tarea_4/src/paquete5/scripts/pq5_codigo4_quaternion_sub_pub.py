...
rospy.init_node('pq5_codigo4_quaternion_sub_pub', anonymous=True)
...
sub = rospy.Subscriber("pq5_codigo3_point_sub_pub", Point, callback)
pub = rospy.Publisher('pq5_codigo4_quaternion_sub_pub', Quaternion, queue_size=10)
