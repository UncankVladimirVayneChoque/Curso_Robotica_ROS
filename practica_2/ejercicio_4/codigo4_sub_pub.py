...
rospy.init_node('codigo3_sub_pub', anonymous=True)	
...
sub = rospy.Subscriber("codigo1_pub", Float64, callback1)
sub = rospy.Subscriber("codigo2_pub", Float64, callback2)
sub = rospy.Subscriber("codigo3_pub", Float64, callback3)

pub = rospy.Publisher('codigo4_sub_pub', Point, queue_size=10)
