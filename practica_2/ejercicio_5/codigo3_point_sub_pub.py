...
rospy.init_node('codigo3_point_sub_pub', anonymous=True)	
...
sub = rospy.Subscriber("codigo1_pub", Int32, callback1)
sub = rospy.Subscriber("codigo2_pub", Int32, callback2)

pub = rospy.Publisher('codigo3_point_sub_pub', Point, queue_size=10)
