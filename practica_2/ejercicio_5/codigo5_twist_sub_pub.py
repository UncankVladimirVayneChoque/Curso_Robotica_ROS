...
rospy.init_node('codigo5_twist_sub_pub', anonymous=True)	
...
sub = rospy.Subscriber("codigo4_quaternion_sub_pub", Quaternion, callback)   
pub = rospy.Publisher('codigo5_twist_sub_pub', Twist, queue_size=10)
