...
def main():
    ...
    aux_pose.pose.position.x = 0.0 # Posicion x respecto a referencia
    aux_pose.pose.position.y = 0.0 # Posicion y respecto a referncia
    aux_pose.pose.position.z = -dist_kuka_piso/2 # Posicion z respecto a referencia
    ...
    box_name = "pilar"
    scene.add_box(box_name, aux_pose, size=(0.2, 0.2, 2))
